...
(function () {
  ...
  BlogService.$inject = ['Restangular', '$q', '$http', 'BLOG_LOCATION', '$sce'];
   ...
   * @param BLOG_LOCATION url for the blog rss feed
   * @param $sce used to process the html of the blog post desciption
   * @constructor
   */
  function BlogService(Restangular, $q, $http, BLOG_LOCATION, $sce) {
