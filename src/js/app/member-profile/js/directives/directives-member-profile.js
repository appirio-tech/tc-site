 ...
 */
'use strict';
angular.module('tc.memberProfileDirectives', [])
  ...
  return {
    ...
    link: function (scope, element, attr) {
      element.on('click', function(){
        // 'user' is a global value defined in ng-page-member-profile.php
        ...
        $location.path('/member-profile/' + user + '/' + attr.tcChangeUrl);
      });
    }
  }
})
