...
<footer class="bottom-footer">
  ...
  <nav class="menu-item">
    ...
    <ul class="submenu">
      <li class="submenu-item"><a href="javascript:;" class="menu-link">SITEMAP</a></li>
      <li class="submenu-item"><a href="javascript:;" class="menu-link">ABOUT US</a></li>
      <li class="submenu-item"><a href="javascript:;" class="menu-link">CONTACT US</a></li>
      <li class="submenu-item"><a href="javascript:;" class="menu-link">HELP CENTER</a></li>
      <li class="submenu-item"><a href="/community/how-it-works/privacy-policy/" class="menu-link">PRIVACY POLICY</a></li>
      <li class="submenu-item"><a href="/community/how-it-works/terms/" class="menu-link">TERMS</a></li>
    </ul>
    <!-- Social links -->
  </nav>
  ...
  <p class="copyright-notice">© 2015 topcoder. All Rights Reserved</p>
</footer>
</div>
<!-- /.content -->
</div>
      ...
      controller: function($scope){
        ...
        vm.menuLinks =
        {
          ...
          'learn': [
              ...
              { 'href': '/community/competitive%20programming/', 'text': 'COMPETITIVE PROGRAMMING', 'icon': '/mf/i/nav/srms.svg' },
          ],
          'community': [
