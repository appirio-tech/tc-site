  ...
  <div class="colCh" ng-if="row.getProperty('challengeCommunity') !== 'data'">
    <div>
      <a ng-href="/challenge-details/{{row.getProperty('challengeId')}}/?type={{row.getProperty('challengeCommunity')}}" class="contestName">
        <img alt="allContestIco" class="allContestIco" ng-src="{{images}}banner-{{row.getProperty('eventName').indexOf('tco') == 0 ? 'tco-' : ''}}{{contest.contestType == 'data' ? 'data' : row.getProperty('challengeCommunity')}}.svg">
