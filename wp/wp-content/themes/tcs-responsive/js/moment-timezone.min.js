        ...
        return s.prototype = {
            ...
            rule: function(t, e, n) {
                var s, r, i, u, a, o = this.ruleYears(t, n),
                    h = 0;
                for (n && (r = n.offset + n.lastRule().offset, i = 9e4 * Math.abs(r)), a = o.length - 1; a > -1; a--) u = s, s = o[a], s.equals(u) || (n && !s.isLast && i >= Math.abs(s.start - n.until) && (h += r - e), s.rule.timeRule === N && (h = e), s.rule.timeRule !== L && s.start.add("m", -h), h = s.rule.offset + e);
            ...
            var r = t.apply(null, n),
                i = r.zone();
            return r.tz(arguments[s]), r.add("minutes", r.zone() - i)
