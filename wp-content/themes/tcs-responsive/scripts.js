...
//           		$('.contestName', row).html('<i></i>' + rec.contestName);
				...
				if (rec.checkpointSubmissionEndDate == null || rec.checkpointSubmissionEndDate == "" || rec.checkpointSubmissionEndDate == "-000001-11-30T00:00:00.000Z") {
					rec.checkpointSubmissionEndDate = ""; // No checkpoint phase
					$('.lEndRound', row).html("");
