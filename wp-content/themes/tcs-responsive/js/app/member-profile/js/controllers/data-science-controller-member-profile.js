 ...
 */
var DataScienceCtrl = function ($scope, MemberProfileService, ChartService) {
  var dataCtrl = this;
  ...
  $scope.$watch('subTrack', function () {
    ...
    if (dataCtrl[dataCtrl.subTrack] === undefined) {
      ...
      MemberProfileService.getDataScienceStats(user, dataCtrl.subTrack, $scope.baseCtrl.cache).then(function (stats) {
