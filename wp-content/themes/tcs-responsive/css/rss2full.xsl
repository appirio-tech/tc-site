...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"  exclude-result-prefixes="feedburner" xmlns:feedburner="http://rssnamespace.org/feedburner/ext/1.0">
         ...
         <div id="bodycontainer">
            <div id="bannerblock">
               ...
               <h1>
                  <xsl:choose>
                     <xsl:when test="link">
                    <a href="{normalize-space(link)}" title="Link to original website"><xsl:value-of select="$title"/></a>
                    </xsl:when>
                    <xsl:otherwise>
     ...
     <xsl:otherwise>
      ...
      <p><xsl:text> </xsl:text></p>
       ...
       <input id="savechoice" type="hidden" value="standard"/>
               ...
               <p class="about">
                  <a href="http://www.google.com/support/feedburner/bin/answer.py?answer=79408">Learn more about syndication and FeedBurner...</a>
               </p>
    ...
    <ul>
     <xsl:apply-templates select="item"/>
            ...
            <div id="footer">
               ...
               <p>FeedBurner delivers the world's subscriptions wherever they need to go. Publish a feed for text or podcasting? <a href="http://feedburner.google.com" target="_blank"><br/>You should try FeedBurner today</a>.</p>
            </div>
         </div>
      </body>
   </xsl:template>
