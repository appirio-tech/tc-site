...
}),app.initZebra(a),$(".loading").hide()},initZebra:function(a){$("tbody tr.alt",a).removeClass("alt"),$("tbody tr:odd",a).addClass("alt")},setPlaceholder:function(a){$(a).each(function(){_this=$(this);var a=_this.attr("placeholder");_this.val(a).addClass("isBlured"),_this.on("focus",function(){$(this).on("blur",function(){$(this).unbind("blur",arguments.callee),""===$.trim($(this).val())&&$(this).val(a).addClass("isBlured")}),$(this).val()===a&&$(this).val("").removeClass("isBlured")})})}},blueprints={challengeRow:'<tr> 						<td class="colCh"><div>								<a href="javascript:;" class="contestName"></a>							</div></td>							<td class="colType"><i class="ico"></i></td>						<td class="colTime"><div>								<div class="row">									<label class="lbl">Start Date</label>									<div class="val vStartDate"> </div>								</div>								<div class="row">									<label class="lbl lEndRound">Round End</label>									<div class="val vEndRound"> </div>								</div>								<div class="row">									<label class="lbl">End Date</label>									<div class="val  vEndDate"> </div>								</div>							</div></td>						<td class="colTLeft"></td>						<td class="colPur"></td>						<td class="colReg"></td>						<td class="colSub"></td>						<td class="action"><!--<a href="javascript:;" class="btn">Submit</a>--></td>					</tr>',partialChallengeRow:'<tr> 						<td class="colCh"><div>								<a href="javascript:;" class="contestName"></a>							</div></td>						<td class="colTime"><div>								<div class="row">									<label class="lbl">Start Date</label>									<div class="val vStartDate"> </div>								</div>								<div class="row">									<label class="lbl lEndRound">Round End</label>									<div class="val vEndRound"> </div>								</div>								<div class="row">									<label class="lbl">End Date</label>									<div class="val  vEndDate"> </div>								</div>							</div></td>						<td class="colPur"></td>					</tr>',challengeGridBlock:'<div class="contest">									<div class="cgCh"><a href="javascript:;" class="contestName"></a></div>									<div class="cgTime">										<div>											<div class="row">												<label class="lbl">Start Date</label>												<div class="val vStartDate"></div>											</div>											<div class="row">												<label class="lbl lEndRound">Round End</label>												<div class="val vEndRound"></div>											</div>											<div class="row">												<label class="lbl">End Date</label>												<div class="val vEndDate"></div>											</div>										</div>									</div>									<div class="genInfo">										<p class="cgTLeft">											<i></i>										</p>										<p class="cgPur">											<i></i>										</p>										<p class="cgReg">											<i></i>										</p>										<p class="cgSub">											<i></i>										</p>									</div>								</div>'};$(document).ready(function(){app.init(),app.initEvents()}),Array.prototype.sum=function(){for(var a=0,b=0,c=this.length;c>a;b+=this[a++]);return b};var coder={initMemberEvents:function(){if($(".subTrackTabs .tabNav a").on(ev,function(){$(".isActive",$(this).closest(".tabNav")).removeClass("isActive"),$(this).addClass("isActive")}),$(".pager .nextLink").on(ev,function(){var a=$(this).closest(".pager"),b=$(".isActive",a).next(".pageLink");b.length>0&&b.trigger("click")}),$(".pager .prevLink").on(ev,function(){var a=$(this).closest(".pager"),b=$(".isActive",a).prev(".pageLink");b.length>0&&b.trigger("click")}),$(".pager .pageLink").on(ev,function(a){var b=$(this).closest(".pager");$(".prevLink",b).show(),$(".nextLink",b).show();$(this).attr("href").replace(/#/g,"");$(".isActive",$(this).closest(".pager")).removeClass("isActive"),$(this).addClass("isActive"),$(".page").hide(),$(".page"+parseInt($(this).text().trim())).show(),$(".pageLink:last",b).hasClass("isActive")&&$(".nextLink",b).hide(),$(".pageLink:first",b).hasClass("isActive")&&$(".prevLink",b).hide(),a.preventDefault()}),$(".viewSwitch a").on(ev,function(a){var b=$(this).attr("href");$(".ratingViews #graphView").hide(),$(".ratingViews #tabularView").hide(),$(".ratingViews "+b).fadeIn(),$(window).resize(),a.preventDefault(),$(".isActive",$(this).closest(".viewSwitch")).removeClass("isActive"),$(this).addClass("isActive")}),$(".submissionCarousel").length>0){var a=$(".submissionCarousel .slider .slide").length;$(".submissionCarousel .slider").iCarousel({slides:5,dir:"rtl",easing:"ease-in-out",slidesSpace:190,mouseWheel:!1,onAfterChange:function(){var a=this.defs.slide;$(".ratingInfo .slider-pager .isActive").removeClass("isActive"),$(".ratingInfo .slider-pager li:eq("+a+") a").addClass("isActive"),$(".submissonInfo .submissionThumb img").attr("src",$("img",this.defs.currentSlide).attr("src")+"?sbt=full");var b=$(".comptetionData",this.defs.currentSlide);$(".winInfo .contestTitle").html("<i></i>"+$(".name",b).val()),$(".winInfo .prizeAmount .val").html("<i></i>"+$(".prize",b).val()),$(".winInfo .submittedOn .time").html($(".submiissionDate",b).val())}}),window.setTimeout(function(){$(".submissionCarousel .slider").trigger("iCarousel:pause"),$(".ratingInfo .slider-pager li:eq(0) a").addClass("isActive")},2e3);for(var b=$("<div class='slider-ctrl'><ul class='slider-pager'></ul></div>"),c=0;a>c;c++)$(".slider-pager",b).append('<li class="slider-pager-item"><a href="javascript:;" class="navDot"></a></li>');$(".ratingInfo").append($(b))}$(".ratingInfo").on(ev,".slider-ctrl a",function(){var a=$(this).parent().index(),b=$(this).closest(".slider-ctrl");return $(".isActive",b).removeClass("isActive"),$(this).addClass("isActive"),$(".submissionCarousel .slider").trigger("iCarousel:goSlide",[a]),!1})},forum:{populate:function(a){""!=xhr&&xhr.abort(),app.setLoading(),xhr=$.getJSON(a,"",function(a){var b=0;$(".forumPosts .forumList").html(null),$.each(a,function(a,c){var d=$(memBluprints.forum).clone();return d.addClass("post"+c.type),$(".postTitle",d).html(c.title),$(".postAuthor",d).html(c.postedBy),$(".postBody",d).html(c.postContent),$(".postCat",d).html(c.postCategory),$(".postedAt",d).html(c.postedOn),$(".nThread em",d).html(c.threads),$(".nMsg em",d).html(c.messages),$(".forumPosts .forumList").append(d),b+=1,b>=postPerPage?($(".loading").hide(),!1):void 0}),$(".loading").hide()})}}},memBluprints={forum:'<div class="post">				<a href="#" class="thumb"></a>				<div class="head">					<a href="#" class="postTitle"></a>					<span class="postedBy">Last Post by: <a href="#" class="postAuthor"></a></span>				</div>				<div class="postBody"></div>				<div class="postInfo">					<div class="row">						<a href="#" class="postCat"></a>						<span class="sep"></span><span class="postedAt"></span>					</div>					<div class="row">						<span class="info nThread"><em>8</em> Threads</span><span class="sep"></span><span class="info nMsg"><em>24</em> Messages</span>					</div>				</div>			</div>'};$.extend(app,coder),$(function(){function a(a){var c=$(a);$("#bgModal").show(),c.show(),b()}function b(){var a=$(".modal:visible");$(window).width()>=1003||$("html").is(".ie6, .ie7, .ie8")?a.css("margin",-a.height()/2+"px 0 0 "+-a.width()/2+"px"):a.css("margin","0")}function c(a){var b=new RegExp("(^[\\+_A-Za-z0-9-]+(\\.[\\+_A-Za-z0-9-]+)*@([A-Za-z0-9-])+((\\.com)|(\\.net)|(\\.org)|(\\.info)|(\\.edu)|(\\.mil)|(\\.gov)|(\\.biz)|(\\.ws)|(\\.us)|(\\.tv)|(\\.cc)|(\\.aero)|(\\.arpa)|(\\.coop)|(\\.int)|(\\.jobs)|(\\.museum)|(\\.name)|(\\.pro)|(\\.travel)|(\\.nato)|(\\..{2,3})|(\\.([A-Za-z0-9-])+\\..{2,3}))$)");return b.test(a)}function d(a){var b=0;return""==a.trim()?0:a.length<7?-2:a.length>30?-3:(a.match(/[a-z]/)&&b++,a.match(/[A-Z]/)&&b++,a.match(/\d/)&&b++,a.match(/[\]\[\!\"\#\$\%\&\'\(\)\*\+\,\.\/\:\;\<\=\>\?\@\\\^\_\`\{\|\}\~\-]/)&&b++,b)}function e(){g=!0;var a=$("#register form.register input.name.handle:text").val();$.ajax({type:"GET",data:{handle:a,action:"get_handle_validity"},dataType:"json",url:ajaxUrl,success:function(a){if(a.error){f=!1;var b=$("#register form.register input.name.handle:text");$("input.handle").closest(".row").find(".err2").show(),$("input.handle").closest(".row").find("input:text").addClass("invalid"),$("input.handle").closest(".row").find("span.valid").hide(),h.resolve()}else{f=!0;var b=$("#register form.register input.name.handle:text");b.parents(".row").find("span.valid").css("display","inline-block"),b.closest(".row").find("input:text").removeClass("invalid"),b.closest(".row").find("span.err1").hide(),b.closest(".row").find("span.err2").hide(),h.resolve()}}}).fail(function(){console.log("fail with "+handleState.handle)})}$(window).on("resize",function(){b()}),$("#username").keyup(function(){$("#loginForm span.err3").hide(),$("#loginForm span.err1").hide(),$(this).removeClass("invalid")}),$("#password").keyup(function(){$("#loginForm span.err1").hide(),$("#loginForm span.err4").hide(),$(this).removeClass("invalid")}),$(".btnRegister").on("click",function(){a("#register")}),$(".actionLogin").on("click",function(){document.getElementById("loginForm").reset(),$("#loginForm .btnSubmit").html("Login"),$(".pwd, .confirm, .strength").parents(".row").show(),$("#register a.btnSubmit").removeClass("socialRegister"),a("#login")}),$(".closeModal,#bgModal").on("click",function(){window.location.replace("/")}),$("input.pwd:password").on("keyup",function(){var a=d($(this).val());$(".strength .field").removeClass("red").removeClass("green");var b="red";$(this).closest(".row").find("span.err3").hide(),$(this).closest(".row").find("span.err4").hide(),a>=3?(b="green",$(this).parents(".row").find("span.valid").css("display","inline-block"),$(this).closest(".row").find("input:text").removeClass("invalid"),$(this).closest(".row").find("span.err1").hide(),$(this).closest(".row").find("span.err2").hide()):$(this).parents(".row").find("span.valid").hide(),$(".strength .field").each(function(c,d){a>c&&$(d).addClass(b)})}),$("#register form.register input.email:text").on("keyup",function(){c($(this).val())?($(this).parents(".row").find("span.valid").css("display","inline-block"),$(this).closest(".row").find("input:text").removeClass("invalid"),$(this).closest(".row").find("span.err1").hide(),$(this).closest(".row").find("span.err2").hide()):$(this).parents(".row").find("span.valid").hide()}),$("#register form.register input.name.lastName:text").on("keyup",function(){var a=$(this).val();a.length>64?($(this).parents(".row").find("span.valid").hide(),$(this).addClass("invalid"),$(this).parents(".row").find("span.err2").show()):""!=a?($(this).parents(".row").find("span.valid").css("display","inline-block"),$(this).closest(".row").find("input:text").removeClass("invalid"),$(this).closest(".row").find("span.err1").hide(),$(this).closest(".row").find("span.err2").hide()):$(this).parents(".row").find("span.valid").hide()}),$("#register form.register input.name.firstName:text").on("keyup",function(){var a=$(this).val();a.length>64?($(this).parents(".row").find("span.valid").hide(),$(this).addClass("invalid"),$(this).parents(".row").find("span.err2").show()):""!=a?($(this).parents(".row").find("span.valid").css("display","inline-block"),$(this).closest(".row").find("input:text").removeClass("invalid"),$(this).closest(".row").find("span.err1").hide(),$(this).closest(".row").find("span.err2").hide()):$(this).parents(".row").find("span.valid").hide()}),$("#register form.register input.handle:text").on("keyup",function(){var a=!1;$(this).parents(".row").find("span.valid").hide(),$(this).closest(".row").find("span.err1").hide(),$(this).closest(".row").find("span.err2").hide(),$(this).closest(".row").find("span.err3").hide(),$(this).closest(".row").find("span.err4").hide(),$(this).closest(".row").find("span.err5").hide(),$(this).closest(".row").find("span.err6").hide();var b=$(this).val();-1!=b.indexOf(" ")?($(this).closest(".row").find("span.err3").show(),a=!0):b.match(/^[\-\_\.\{\}\[\]]+$/)?($(this).closest(".row").find("span.err4").show(),a=!0):b.match(/^[\w\d\-\_\.\{\}\[\]]*$/)?b.toLowerCase().match(/^admin/)&&($(this).closest(".row").find("span.err6").show(),a=!0):($(this).closest(".row").find("span.err5").show(),a=!0),a?$("#register form.register input.handle:text").addClass("invalid"):$("#register form.register input.handle:text").removeClass("invalid")}),$("#register form.register input:checkbox").on("change",function(){$(this).prop("checked")?($(this).parents(".row").find("span.valid").css("display","inline-block"),$(this).closest(".row").find("input:text").removeClass("invalid"),$(this).closest(".row").find("span.err1").hide(),$(this).closest(".row").find("span.err2").hide()):$(this).parents(".row").find("span.valid").hide()}),$("#register input:password").on("keyup",function(){var a=$("#register form.register input.pwd:password"),b=$("#register form.register input.confirm:password");$(this).hasClass("pwd")&&(""!=$(this).val()?($(this).closest(".row").find("span.err1").hide(),$(this).closest(".row").find("span.err2").hide(),$(this).closest(".row").find("input:password").removeClass("invalid")):$(this).parents(".row").find("span.valid").hide()),a.val()==b.val()?(b.parents(".row").find("span.valid").css("display","inline-block"),b.parents(".row").find("input:text").removeClass("invalid"),b.parents(".row").find("span.err1").hide(),b.parents(".row").find("span.err2").hide()):b.parents(".row").find("span.valid").hide()}),$("select").on("change",function(){""!=$(this).val()?($(this).parents(".row").find("span.valid").css("display","inline-block"),$(this).closest(".row").find(".err1").hide(),$(this).closest(".row").find(".err2").hide(),$(this).closest(".row").find(".customSelect").removeClass("invalid")):$(this).parents(".row").find("span.valid").hide()});var f=!0,g=!1,h=$.Deferred();$("#register form.register input.name.handle:text").blur(function(){""==$(this).val()||$("input.handle").closest(".row").find(".err3,.err4,.err5,.err6").is(":visible")||(e(),h=$.Deferred())}),$("select").customSelect(),$("#register a.btnSubmit").on("click",function(){var b=!0;g||$("input.handle").closest(".row").find(".err3,.err4,.err5,.err6").is(":visible")||e();var i=$("#register form.register"),j=$("input.handle").closest(".row").find(".invalid");$(".invalid",i).not(j).removeClass("invalid");var k=$("input.handle").closest(".row").find(".err2,.err3,.err4,.err5,.err6");$(".err1,.err2",i).not(k).hide(),$("input:text",i).each(function(){""==$.trim($(this).val())&&($(this).closest(".row").find(".err1").show(),$(this).closest(".row").find("input:text").addClass("invalid"),b=!1)}),$("input.firstName,input.lastName").each(function(){$(this).val().length>64&&(b=!1,$(this).addClass("invalid"),$(this).closest(".row").find(".err2").show())}),$("select",i).each(function(){""==$.trim($(this).val())&&($(this).closest(".row").find(".err1").show(),$(this).closest(".row").find(".customSelect").addClass("invalid"),b=!1)}),$("input.email:text",i).each(function(){""==$.trim($(this).val())?($(this).closest(".row").find(".err1").show(),$(this).closest(".row").find("input.email:text").addClass("invalid"),b=!1):c($(this).val())||($(this).closest(".row").find(".err2").show(),$(this).closest(".row").find("input.email:text").addClass("invalid"),b=!1)}),$(this).hasClass("socialRegister")||$("input.pwd:password",i).each(function(){""==$(this).val()?($(this).closest(".row").find(".err1").show(),$(this).closest(".row").find("input:password").addClass("invalid"),b=!1):$(".strength .field.red",i).length>0?(i.find(".err2.red").show(),$(this).closest(".row").find(".err2").show(),$(this).closest(".row").find("input:password").addClass("invalid"),b=!1):d($("input.pwd:password").val())<-1&&(i.find(".err4.red").show(),$(this).closest(".row").find(".err4").show(),$(this).closest(".row").find("input:password").addClass("invalid"),b=!1),$("input.pwd:password",i).val()!=$("input.confirm:password",i).val()?($("input.confirm:password").closest(".row").find(".err2").show(),$("input.confirm:password").closest(".row").find("input:password").addClass("invalid"),b=!1):""==$("input.confirm:password",i).val()&&($("input.confirm:password").closest(".row").find(".err1").show(),$("input.confirm:password").closest(".row").find("input:password").addClass("invalid"),b=!1)}),$(".lSpace input:checkbox",i).each(function(){$(this).is(":checked")||($(this).closest(".row").find(".err1").show(),b=!1)});var l=$("#register form.register input.name.handle:text").val();""==l&&($("input.handle").closest(".row").find(".err1").show(),$("input.handle").closest(".row").find("input:text").addClass("invalid"),$("input.handle").closest(".row").find("span.valid").hide(),b=!1),$("input.handle").closest(".row").find(".err3,.err4,.err5,.err6").is(":visible")&&(b=!1),b&&h.done(function(){if(f||($("input.handle").closest(".row").find(".err2").show(),$("input.handle").closest(".row").find("input:text").addClass("invalid"),$("input.handle").closest(".row").find("span.valid").hide(),b=!1),b&&"Sign Up"==$("#register a.btnSubmit").html()){$("#register a.btnSubmit").html("Please Wait"),$("#register .btnSubmit").addClass("pleaseWait");var c={firstName:$("#registerForm input.firstName").val(),lastName:$("#registerForm input.lastName").val(),handle:$("#registerForm input.handle").val(),country:$("#registerForm select#selCountry").val(),email:$("#registerForm input.email").val()};"undefined"!=typeof socialProviderId&&""!==socialProviderId?(c.socialProviderId=socialProviderId,c.socialUserId=socialUserId,c.socialProvider=socialProvider,c.socialUserName=socialUserName,c.socialEmail=socialEmail,c.socialEmailVerified="t"):c.password=$("#registerForm  input.pwd").val(),$.post(ajaxUrl+"?action=post_register",c,function(b){"200"==b.code?($(".modal").hide(),$("#thanks h2").html("Thanks for Registering"),$("#thanks p").html('We have sent you an email with activation instructions.<br>If you do not receive that email within 1 hour, please email <a href="mailto:support@topcoder.com">support@topcoder.com</a>'),a("#thanks"),$("#registerForm .invalid").removeClass("invalid"),$("#registerForm .valid").removeClass("valid"),$(".err1,.err2",i).hide(),resetRegisterFields()):alert(b.description),$("#register .btnSubmit").html("Sign Up")},"json")}})}),$("#login a.btnSubmit").on("click",function(){var a=$(this).closest("form.login");$(".invalid",a).removeClass("invalid"),$(".err1,.err2",a).hide();var b=!0;$("input:password",a).each(function(){""==$(this).val()&&($(this).closest(".row").parent().find(".err2").show(),$(this).closest(".row").find("input:password").addClass("invalid"),b=!1)}),b&&$("#loginForm .btnSubmit").html("Please wait")}),$(".animeButton").each(function(){var a=$(this).find(".animeButtonHover",this).css("opacity",0);$(this).hover(function(){$("html").is(".ie6, .ie7, .ie8")?a.css("opacity",1):a.stop().fadeTo(500,1)},function(){$("html").is(".ie6, .ie7, .ie8")?a.css("opacity",0):a.stop().fadeTo(500,0)})}),$(".person label").each(function(){var a=$(this).find(".animeManHover",this).css("opacity",0);$(this).hover(function(){$("html").is(".ie6, .ie7, .ie8")?a.css("opacity",1):a.stop().fadeTo(500,1)},function(){$("html").is(".ie6, .ie7, .ie8")?a.css("opacity",0):a.stop().fadeTo(500,0)})})}),$(document).ready(function(){window.mySwipe=$("#mySwipe").Swipe({callback:function(a){var b=$("#mySwipe .swipeNavWrapper a").length,c=a%b;$("#mySwipe .swipeNavWrapper a").removeClass("on"),$("#swipeNav"+c).addClass("on")}}).data("Swipe"),$("#mySwipe .swipeNavWrapper a").click(function(){var a=$(this).attr("id"),b=parseInt(a.replace("swipeNav",""));mySwipe.slide(b)}),$("#showMoreBlogPost").click(function(){var a="get_blog_ajax",b=$(this).parent().parent().find(".pageNo").val(),c=$(this).parent().parent().find(".catId").val(),d=$(this).parent().parent().find(".searchKey").val();b++,$(this).hide(),$(this).parent().find(".morePostLoading").css("display","inline-block"),$.ajax({type:"GET",context:this,url:ajaxUrl,data:{action:a,page:b,catId:c,searchKey:d},dataType:"html",success:function(a){""!=$.trim(a)?($(this).parent().parent().find(".blogsWrapper").append(a),$(this).parent().parent().find(".pageNo").val(b),$(this).parent().find(".morePostLoading").hide(),$(this).show()):($(this).parent().find(".morePostLoading").hide(),$(this).hide(),$(this).parent().find(".noMorePostExist").css("display","inline-block"))},error:function(){alert("error")}})}),$("#popularShowMore").click(function(){var a="get_popular_ajax",b=$(this).parent().parent().find(".pageNo").val(),c=$(this).parent().parent().find(".popularPostPage").val();b++,$(this).hide(),$(this).parent().find(".morePostLoading").css("display","inline-block"),$.ajax({type:"GET",context:this,url:ajaxUrl,data:{action:a,page:b,posts_per_page:c},dataType:"html",success:function(a){""!=$.trim(a)?($(this).parent().parent().find(".relatedContentList").append(a),$(this).parent().parent().find(".pageNo").val(b),$(this).parent().find(".morePostLoading").hide(),$(this).show()):($(this).parent().find(".morePostLoading").hide(),$(this).hide(),$(this).parent().find(".noMorePostExist").css("display","inline-block"))},error:function(){alert("error")}})}),$(".subscribeButton").click(function(){var a=$(this).parent().parent().find(".subscribeInput").val();$(this).parent().parent().find(".errorInput").html(""),a=$.trim(a),""==a?$(".subscribeBox .errorInput").html("Please fill the email!"):validateEmail(a)?$(".subscribeBox form").submit():$(".subscribeBox .errorInput").html("Email is invalid email format!")})}),$(document).ready(function(){function a(){var a=b.width();1019>a?($("#hero .point").animate({left:"50%"},200),$(".contact .trackInfo").click(function(){var a=$(this).attr("id");$(".contactInfo > .container > .descBox").each(function(){$(this).attr("class","descBox"),$("#"+a+"Box").addClass("activeBox")}),$("html, body").animate({scrollTop:$("#hero").offset().top},500)})):($(".contact #register").hover(function(){$(window).width()>1019&&$("#hero .point").animate({left:"165.5px"},200)},function(){$(window).width()>1019&&$("#hero .point").animate({left:"505.5px"},200)}),$(".contact #support").hover(function(){$(window).width()>1019&&$("#hero .point").animate({left:"845.5px"},200)},function(){$(window).width()>1019&&$("#hero .point").animate({left:"505.5px"},200)}),$(".contact .trackInfo").hover(function(){var a=$(this).attr("id");$(".contactInfo > .container > .descBox").each(function(){$(this).attr("class","descBox"),$("#"+a+"Box").addClass("activeBox")})}))}$(".teamView .showMore").on("click",function(){$(".members").css("height","auto"),$(this).closest(".actions").hide()}),$(".contact .btnSubmit").click(function(){var a=$(this).closest(".contactForm");$(".error",a).removeClass("error"),$(".errormsg",a).hide();var b=!0;$("input:text, .textarea",a).each(function(){""==$.trim($(this).val())&&($(this).closest(".row").addClass("error"),b=!1)}),$("#ea",a).each(function(){(""==$.trim($(this).val())||null===$.trim($(this).val()).match(/^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/g))&&($(this).closest(".row").addClass("error"),b=!1)}),b?$("#contactForm").submit():$(".errormsg",a).fadeIn()}),$(".contact .contactForm input, .contact .contactForm textarea").focus(function(){$(this).closest(".row").removeClass("error");var a=$(this).closest(".contactForm");$(".error",a).length<=0&&$(".errormsg",a).hide()});var b=$(document);a(),$(window).resize(a)}),$(document).ready(function(){if($(".tcssoUsingJS").length>0){var a=getCookie("tcsso");if(a){$(".actionLogout").attr("href","javascript:;"),$(".loginLink, .linkLogin, .btnRegister").addClass("hide").hide(),$(".logoutLink, .linkLogout, .userDetailsWrapper").removeClass("hide").show(),$(".headerTopRightMenuLink.logIn a").unbind("click"),$(".headerTopRightMenuLink.logIn a").text("Log Out").removeClass("actionLogin").addClass("actionLogout");var b=a.split("|");$.getJSON("http://community.topcoder.com/tc?module=BasicData&c=get_handle_by_id&dsid=30&uid="+b[0]+"&json=true",function(a){var b=a.data[0].handle;$(".userDetails .coder").text(b),$.getJSON(ajaxUrl,{action:"get_member_profile",handle:b},function(a){a.photoLink?$(".userPic img").attr("src","http://community.topcoder.com"+a.photoLink):$(".userPic img").attr("src","http://community.topcoder.com/i/m/nophoto_login.gif"),$(".userDetails .coder").attr("href",$(".userDetails .coder").attr("href")+b),$(".userDetails .link").attr("href",$(".userDetails .link").attr("href")+b),$(".action .profileLink").attr("href",$(".action .profileLink").attr("href")+b);var c="";if(a.ratingsSummary)for(var d=0,e=0;e<a.ratingsSummary.length;e++)d<a.ratingsSummary[e].rating&&(d=a.ratingsSummary[e].rating,c=a.ratingsSummary[e].colorStyle.split(": ")[1]);else 1==a.isPM&&(c="#FF9900");$(".userDetails .coder").attr("style","color: "+c);var f=wpUrl+"/member-profile/"+b;$(".userWidget .userDetails").prepend('<a class="tc_coder coder" href="'+f+'" style="color:'+c+'">'+b+"</a>"),$(".myProfileLink, .profileLink").attr("href",f),$(".userDetails .country").text(a.country),$(".userDetails .memberSince").text(dateformat(a.memberSince)),$(".userDetails .memberEarning").text(a.overallEarning?"$"+a.overallEarning:"")}),$("#navigation, .sidebarNav").removeClass("newUser")}),$(".logoutLink, .actionLogout").click(function(){document.cookie="tcsso=; path=/; domain=.topcoder.com; expires="+new Date(0).toUTCString(),location.href="#_=_"==window.location.hash?"":location.href})}}$("#login input").keyup(function(a){13==a.keyCode&&$("#login a.btnSubmit").click()})});var sliderActive=!1,prizeSliderActive=!1,slider,prizeSlider,sliderClone;$(document).ready(function(){window.innerWidth<1019?($(".rightColumn").insertAfter(".leftColumn"),$(".grid-1-3").insertBefore("#contest-overview"),$(".scroll-pane").jScrollPane({autoReinitialise:!0}),sliderActive=createSlider(),$("#stepBox .rightColumn .nextBox .allDeadlineNextBoxContent p:nth-child(3)").addClass("moveRight"),$(".studio").length>0&&updateDesignContestMobile(),updateDeadlineBoxMobile(),$(".registrantsTable").not(".mobile").addClass("hide"),$(".registrantsTable.mobile").removeClass("hide")):($(".studio").length>0&&updateDesignContest(),updateDeadlineBox(),$(".registrantsTable").not(".mobile").removeClass("hide"),$(".registrantsTable.mobile").addClass("hide")),$('a[href="'+getAnchor(location.href)+'"]').click()}),$(window).resize(function(){window.innerWidth<1019&&(0==sliderActive&&($(".rightColumn").insertAfter(".leftColumn"),$(".grid-1-3").insertBefore("#contest-overview"),$(".scroll-pane").jScrollPane({autoReinitialise:!0}),sliderActive=createSlider()),$(".studio").length>0&&updateDesignContestMobile(),updateDeadlineBoxMobile(),$(".registrantsTable").not(".mobile").addClass("hide"),$(".registrantsTable.mobile").removeClass("hide")),window.innerWidth>1019&&(1==sliderActive&&($(".rightColumn").insertAfter(".middleColumn"),$(".grid-1-3").insertAfter(".rightSplit"),$(".scroll-pane").jScrollPane({autoReinitialise:!0}),slider.destroySlider(),sliderActive=!1,$(".slider > ul:first-child").replaceWith(sliderClone)),$(".studio").length>0&&updateDesignContest(),updateDeadlineBox(),$(".registrantsTable").not(".mobile").removeClass("hide"),$(".registrantsTable.mobile").addClass("hide"))}),$(window).bind("orientationchange",function(){$(".scroll-pane").jScrollPane({autoReinitialise:!0})});var getElementsByClassName=function(a,b,c){if(document.getElementsByClassName)return document.getElementsByClassName(a);b=b||document,c=c||"*";var d=[],e="*"===c&&b.all?b.all:b.getElementsByTagName(c),f=e.length;a=a.replace(/\-/g,"\\-");for(var g=new RegExp("(^|\\s)"+a+"(\\s|$)");--f>=0;)g.test(e[f].className)&&d.push(e[f]);return d},tooltipTimeout;$(function(){$(".scroll-pane").jScrollPane(),$(".viewAllDeadLineBtn").click(function(){$(".nextDeadlinedeadlineBoxContent").addClass("hide"),$(".allDeadlinedeadlineBoxContent").removeClass("hide"),$(".nextDeadlineNextBoxContent").addClass("hide"),$(".allDeadlineNextBoxContent").removeClass("hide"),$(".contestEndedBox").addClass("hide")}),$(".viewNextDeadLineBtn").click(function(){$(".contestEndedBox").addClass("hide"),$(".allDeadlinedeadlineBoxContent").addClass("hide"),$(".nextDeadlinedeadlineBoxContent").removeClass("hide"),$(".allDeadlineNextBoxContent").addClass("hide"),$(".nextDeadlineNextBoxContent").removeClass("hide")}),$(".morePayments.active").click(function(){$(this).hasClass("closed")?($(".morePayments.active").removeClass("closed"),$(".morePayments.active").addClass("open"),$(".additionalPrizes").removeClass("hide")):($(".morePayments.active").removeClass("open"),$(".morePayments.active").addClass("closed"),$(".additionalPrizes").addClass("hide"))})}),function(a,b,c){a.fn.jScrollPane=function(d){function e(d,e){function f(b){var e,h,j,l,m,n,q=!1,r=!1;if(P=b,Q===c)m=d.scrollTop(),n=d.scrollLeft(),d.css({overflow:"hidden",padding:0}),R=d.innerWidth()+tb,S=d.innerHeight(),d.width(R),Q=a('<div class="jspPane" />').css("padding",sb).append(d.children()),T=a('<div class="jspContainer" />').css({width:R+"px",height:S+"px"}).append(Q).appendTo(d);else{if(d.css("width",""),q=P.stickToBottom&&C(),r=P.stickToRight&&D(),l=d.innerWidth()+tb!=R||d.outerHeight()!=S,l&&(R=d.innerWidth()+tb,S=d.innerHeight(),T.css({width:R+"px",height:S+"px"})),!l&&ub==U&&Q.outerHeight()==V)return void d.width(R);ub=U,Q.css("width",""),d.width(R),T.find(">.jspVerticalBar,>.jspHorizontalBar").remove().end()}Q.css("overflow","auto"),U=b.contentWidth?b.contentWidth:Q[0].scrollWidth,V=Q[0].scrollHeight,Q.css("overflow",""),W=U/R,X=V/S,Y=X>1,Z=W>1,Z||Y?(d.addClass("jspScrollable"),e=P.maintainPosition&&(ab||db),e&&(h=A(),j=B()),g(),i(),k(),e&&(y(r?U-R:h,!1),x(q?V-S:j,!1)),H(),E(),N(),P.enableKeyboardNavigation&&J(),P.clickOnTrack&&o(),L(),P.hijackInternalLinks&&M()):(d.removeClass("jspScrollable"),Q.css({top:0,width:T.width()-tb}),F(),I(),K(),p()),P.autoReinitialise&&!rb?rb=setInterval(function(){f(P)},P.autoReinitialiseDelay):!P.autoReinitialise&&rb&&clearInterval(rb),m&&d.scrollTop(0)&&x(m,!1),n&&d.scrollLeft(0)&&y(n,!1),d.trigger("jsp-initialised",[Z||Y])}function g(){Y&&(T.append(a('<div class="jspVerticalBar" />').append(a('<div class="jspCap jspCapTop" />'),a('<div class="jspTrack" />').append(a('<div class="jspDrag" />').append(a('<div class="jspDragTop" />'),a('<div class="jspDragBottom" />'))),a('<div class="jspCap jspCapBottom" />'))),eb=T.find(">.jspVerticalBar"),fb=eb.find(">.jspTrack"),$=fb.find(">.jspDrag"),P.showArrows&&(jb=a('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp",m(0,-1)).bind("click.jsp",G),kb=a('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp",m(0,1)).bind("click.jsp",G),P.arrowScrollOnHover&&(jb.bind("mouseover.jsp",m(0,-1,jb)),kb.bind("mouseover.jsp",m(0,1,kb))),l(fb,P.verticalArrowPositions,jb,kb)),hb=S,T.find(">.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow").each(function(){hb-=a(this).outerHeight()}),$.hover(function(){$.addClass("jspHover")},function(){$.removeClass("jspHover")}).bind("mousedown.jsp",function(b){a("html").bind("dragstart.jsp selectstart.jsp",G),$.addClass("jspActive");var c=b.pageY-$.position().top;return a("html").bind("mousemove.jsp",function(a){r(a.pageY-c,!1)}).bind("mouseup.jsp mouseleave.jsp",q),!1}),h())}function h(){fb.height(hb+"px"),ab=0,gb=P.verticalGutter+fb.outerWidth(),Q.width(R-gb-tb);try{0===eb.position().left&&Q.css("margin-left",gb+"px")}catch(a){}}function i(){Z&&(T.append(a('<div class="jspHorizontalBar" />').append(a('<div class="jspCap jspCapLeft" />'),a('<div class="jspTrack" />').append(a('<div class="jspDrag" />').append(a('<div class="jspDragLeft" />'),a('<div class="jspDragRight" />'))),a('<div class="jspCap jspCapRight" />'))),lb=T.find(">.jspHorizontalBar"),mb=lb.find(">.jspTrack"),bb=mb.find(">.jspDrag"),P.showArrows&&(pb=a('<a class="jspArrow jspArrowLeft" />').bind("mousedown.jsp",m(-1,0)).bind("click.jsp",G),qb=a('<a class="jspArrow jspArrowRight" />').bind("mousedown.jsp",m(1,0)).bind("click.jsp",G),P.arrowScrollOnHover&&(pb.bind("mouseover.jsp",m(-1,0,pb)),qb.bind("mouseover.jsp",m(1,0,qb))),l(mb,P.horizontalArrowPositions,pb,qb)),bb.hover(function(){bb.addClass("jspHover")},function(){bb.removeClass("jspHover")}).bind("mousedown.jsp",function(b){a("html").bind("dragstart.jsp selectstart.jsp",G),bb.addClass("jspActive");
var c=b.pageX-bb.position().left;return a("html").bind("mousemove.jsp",function(a){t(a.pageX-c,!1)}).bind("mouseup.jsp mouseleave.jsp",q),!1}),nb=T.innerWidth(),j())}function j(){T.find(">.jspHorizontalBar>.jspCap:visible,>.jspHorizontalBar>.jspArrow").each(function(){nb-=a(this).outerWidth()}),mb.width(nb+"px"),db=0}function k(){if(Z&&Y){var b=mb.outerHeight(),c=fb.outerWidth();hb-=b,a(lb).find(">.jspCap:visible,>.jspArrow").each(function(){nb+=a(this).outerWidth()}),nb-=c,S-=c,R-=b,mb.parent().append(a('<div class="jspCorner" />').css("width",b+"px")),h(),j()}Z&&Q.width(T.outerWidth()-tb+"px"),V=Q.outerHeight(),X=V/S,Z&&(ob=Math.ceil(1/W*nb),ob>P.horizontalDragMaxWidth?ob=P.horizontalDragMaxWidth:ob<P.horizontalDragMinWidth&&(ob=P.horizontalDragMinWidth),bb.width(ob+"px"),cb=nb-ob,u(db)),Y&&(ib=Math.ceil(1/X*hb),ib>P.verticalDragMaxHeight?ib=P.verticalDragMaxHeight:ib<P.verticalDragMinHeight&&(ib=P.verticalDragMinHeight),$.height(ib+"px"),_=hb-ib,s(ab))}function l(a,b,c,d){var e,f="before",g="after";"os"==b&&(b=/Mac/.test(navigator.platform)?"after":"split"),b==f?g=b:b==g&&(f=b,e=c,c=d,d=e),a[f](c)[g](d)}function m(a,b,c){return function(){return n(a,b,this,c),this.blur(),!1}}function n(b,c,d,e){d=a(d).addClass("jspActive");var f,g,h=!0,i=function(){0!==b&&vb.scrollByX(b*P.arrowButtonSpeed),0!==c&&vb.scrollByY(c*P.arrowButtonSpeed),g=setTimeout(i,h?P.initialDelay:P.arrowRepeatFreq),h=!1};i(),f=e?"mouseout.jsp":"mouseup.jsp",e=e||a("html"),e.bind(f,function(){d.removeClass("jspActive"),g&&clearTimeout(g),g=null,e.unbind(f)})}function o(){p(),Y&&fb.bind("mousedown.jsp",function(b){if(b.originalTarget===c||b.originalTarget==b.currentTarget){var d,e=a(this),f=e.offset(),g=b.pageY-f.top-ab,h=!0,i=function(){var a=e.offset(),c=b.pageY-a.top-ib/2,f=S*P.scrollPagePercent,k=_*f/(V-S);if(0>g)ab-k>c?vb.scrollByY(-f):r(c);else{if(!(g>0))return void j();c>ab+k?vb.scrollByY(f):r(c)}d=setTimeout(i,h?P.initialDelay:P.trackClickRepeatFreq),h=!1},j=function(){d&&clearTimeout(d),d=null,a(document).unbind("mouseup.jsp",j)};return i(),a(document).bind("mouseup.jsp",j),!1}}),Z&&mb.bind("mousedown.jsp",function(b){if(b.originalTarget===c||b.originalTarget==b.currentTarget){var d,e=a(this),f=e.offset(),g=b.pageX-f.left-db,h=!0,i=function(){var a=e.offset(),c=b.pageX-a.left-ob/2,f=R*P.scrollPagePercent,k=cb*f/(U-R);if(0>g)db-k>c?vb.scrollByX(-f):t(c);else{if(!(g>0))return void j();c>db+k?vb.scrollByX(f):t(c)}d=setTimeout(i,h?P.initialDelay:P.trackClickRepeatFreq),h=!1},j=function(){d&&clearTimeout(d),d=null,a(document).unbind("mouseup.jsp",j)};return i(),a(document).bind("mouseup.jsp",j),!1}})}function p(){mb&&mb.unbind("mousedown.jsp"),fb&&fb.unbind("mousedown.jsp")}function q(){a("html").unbind("dragstart.jsp selectstart.jsp mousemove.jsp mouseup.jsp mouseleave.jsp"),$&&$.removeClass("jspActive"),bb&&bb.removeClass("jspActive")}function r(a,b){Y&&(0>a?a=0:a>_&&(a=_),b===c&&(b=P.animateScroll),b?vb.animate($,"top",a,s):($.css("top",a),s(a)))}function s(a){a===c&&(a=$.position().top),T.scrollTop(0),ab=a;var b=0===ab,e=ab==_,f=a/_,g=-f*(V-S);(wb!=b||yb!=e)&&(wb=b,yb=e,d.trigger("jsp-arrow-change",[wb,yb,xb,zb])),v(b,e),Q.css("top",g),d.trigger("jsp-scroll-y",[-g,b,e]).trigger("scroll")}function t(a,b){Z&&(0>a?a=0:a>cb&&(a=cb),b===c&&(b=P.animateScroll),b?vb.animate(bb,"left",a,u):(bb.css("left",a),u(a)))}function u(a){a===c&&(a=bb.position().left),T.scrollTop(0),db=a;var b=0===db,e=db==cb,f=a/cb,g=-f*(U-R);(xb!=b||zb!=e)&&(xb=b,zb=e,d.trigger("jsp-arrow-change",[wb,yb,xb,zb])),w(b,e),Q.css("left",g),d.trigger("jsp-scroll-x",[-g,b,e]).trigger("scroll")}function v(a,b){P.showArrows&&(jb[a?"addClass":"removeClass"]("jspDisabled"),kb[b?"addClass":"removeClass"]("jspDisabled"))}function w(a,b){P.showArrows&&(pb[a?"addClass":"removeClass"]("jspDisabled"),qb[b?"addClass":"removeClass"]("jspDisabled"))}function x(a,b){var c=a/(V-S);r(c*_,b)}function y(a,b){var c=a/(U-R);t(c*cb,b)}function z(b,c,d){var e,f,g,h,i,j,k,l,m,n=0,o=0;try{e=a(b)}catch(p){return}for(f=e.outerHeight(),g=e.outerWidth(),T.scrollTop(0),T.scrollLeft(0);!e.is(".jspPane");)if(n+=e.position().top,o+=e.position().left,e=e.offsetParent(),/^body|html$/i.test(e[0].nodeName))return;h=B(),j=h+S,h>n||c?l=n-P.verticalGutter:n+f>j&&(l=n-S+f+P.verticalGutter),l&&x(l,d),i=A(),k=i+R,i>o||c?m=o-P.horizontalGutter:o+g>k&&(m=o-R+g+P.horizontalGutter),m&&y(m,d)}function A(){return-Q.position().left}function B(){return-Q.position().top}function C(){var a=V-S;return a>20&&a-B()<10}function D(){var a=U-R;return a>20&&a-A()<10}function E(){T.unbind(Bb).bind(Bb,function(a,b,c,d){var e=db,f=ab;return vb.scrollBy(c*P.mouseWheelSpeed,-d*P.mouseWheelSpeed,!1),e==db&&f==ab})}function F(){T.unbind(Bb)}function G(){return!1}function H(){Q.find(":input,a").unbind("focus.jsp").bind("focus.jsp",function(a){z(a.target,!1)})}function I(){Q.find(":input,a").unbind("focus.jsp")}function J(){function b(){var a=db,b=ab;switch(c){case 40:vb.scrollByY(P.keyboardSpeed,!1);break;case 38:vb.scrollByY(-P.keyboardSpeed,!1);break;case 34:case 32:vb.scrollByY(S*P.scrollPagePercent,!1);break;case 33:vb.scrollByY(-S*P.scrollPagePercent,!1);break;case 39:vb.scrollByX(P.keyboardSpeed,!1);break;case 37:vb.scrollByX(-P.keyboardSpeed,!1)}return e=a!=db||b!=ab}var c,e,f=[];Z&&f.push(lb[0]),Y&&f.push(eb[0]),Q.focus(function(){d.focus()}),d.attr("tabindex",0).unbind("keydown.jsp keypress.jsp").bind("keydown.jsp",function(d){if(d.target===this||f.length&&a(d.target).closest(f).length){var g=db,h=ab;switch(d.keyCode){case 40:case 38:case 34:case 32:case 33:case 39:case 37:c=d.keyCode,b();break;case 35:x(V-S),c=null;break;case 36:x(0),c=null}return e=d.keyCode==c&&g!=db||h!=ab,!e}}).bind("keypress.jsp",function(a){return a.keyCode==c&&b(),!e}),P.hideFocus?(d.css("outline","none"),"hideFocus"in T[0]&&d.attr("hideFocus",!0)):(d.css("outline",""),"hideFocus"in T[0]&&d.attr("hideFocus",!1))}function K(){d.attr("tabindex","-1").removeAttr("tabindex").unbind("keydown.jsp keypress.jsp")}function L(){if(location.hash&&location.hash.length>1){var b,c,d=escape(location.hash.substr(1));try{b=a("#"+d+', a[name="'+d+'"]')}catch(e){return}b.length&&Q.find(d)&&(0===T.scrollTop()?c=setInterval(function(){T.scrollTop()>0&&(z(b,!0),a(document).scrollTop(T.position().top),clearInterval(c))},50):(z(b,!0),a(document).scrollTop(T.position().top)))}}function M(){a(document.body).data("jspHijack")||(a(document.body).data("jspHijack",!0),a(document.body).delegate("a[href*=#]","click",function(c){var d,e,f,g,h,i,j=this.href.substr(0,this.href.indexOf("#")),k=location.href;if(-1!==location.href.indexOf("#")&&(k=location.href.substr(0,location.href.indexOf("#"))),j===k){d=escape(this.href.substr(this.href.indexOf("#")+1));try{e=a("#"+d+', a[name="'+d+'"]')}catch(l){return}e.length&&(f=e.closest(".jspScrollable"),g=f.data("jsp"),g.scrollToElement(e,!0),f[0].scrollIntoView&&(h=a(b).scrollTop(),i=e.offset().top,(h>i||i>h+a(b).height())&&f[0].scrollIntoView()),c.preventDefault())}}))}function N(){var a,b,c,d,e,f=!1;T.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp",function(g){var h=g.originalEvent.touches[0];a=A(),b=B(),c=h.pageX,d=h.pageY,e=!1,f=!0}).bind("touchmove.jsp",function(g){if(f){var h=g.originalEvent.touches[0],i=db,j=ab;return vb.scrollTo(a+c-h.pageX,b+d-h.pageY),e=e||Math.abs(c-h.pageX)>5||Math.abs(d-h.pageY)>5,i==db&&j==ab}}).bind("touchend.jsp",function(){f=!1}).bind("click.jsp-touchclick",function(){return e?(e=!1,!1):void 0})}function O(){var a=B(),b=A();d.removeClass("jspScrollable").unbind(".jsp"),d.replaceWith(Ab.append(Q.children())),Ab.scrollTop(a),Ab.scrollLeft(b),rb&&clearInterval(rb)}var P,Q,R,S,T,U,V,W,X,Y,Z,$,_,ab,bb,cb,db,eb,fb,gb,hb,ib,jb,kb,lb,mb,nb,ob,pb,qb,rb,sb,tb,ub,vb=this,wb=!0,xb=!0,yb=!1,zb=!1,Ab=d.clone(!1,!1).empty(),Bb=a.fn.mwheelIntent?"mwheelIntent.jsp":"mousewheel.jsp";sb=d.css("paddingTop")+" "+d.css("paddingRight")+" "+d.css("paddingBottom")+" "+d.css("paddingLeft"),tb=(parseInt(d.css("paddingLeft"),10)||0)+(parseInt(d.css("paddingRight"),10)||0),a.extend(vb,{reinitialise:function(b){b=a.extend({},P,b),f(b)},scrollToElement:function(a,b,c){z(a,b,c)},scrollTo:function(a,b,c){y(a,c),x(b,c)},scrollToX:function(a,b){y(a,b)},scrollToY:function(a,b){x(a,b)},scrollToPercentX:function(a,b){y(a*(U-R),b)},scrollToPercentY:function(a,b){x(a*(V-S),b)},scrollBy:function(a,b,c){vb.scrollByX(a,c),vb.scrollByY(b,c)},scrollByX:function(a,b){var c=A()+Math[0>a?"floor":"ceil"](a),d=c/(U-R);t(d*cb,b)},scrollByY:function(a,b){var c=B()+Math[0>a?"floor":"ceil"](a),d=c/(V-S);r(d*_,b)},positionDragX:function(a,b){t(a,b)},positionDragY:function(a,b){r(a,b)},animate:function(a,b,c,d){var e={};e[b]=c,a.animate(e,{duration:P.animateDuration,easing:P.animateEase,queue:!1,step:d})},getContentPositionX:function(){return A()},getContentPositionY:function(){return B()},getContentWidth:function(){return U},getContentHeight:function(){return V},getPercentScrolledX:function(){return A()/(U-R)},getPercentScrolledY:function(){return B()/(V-S)},getIsScrollableH:function(){return Z},getIsScrollableV:function(){return Y},getContentPane:function(){return Q},scrollToBottom:function(a){r(_,a)},hijackInternalLinks:a.noop,destroy:function(){O()}}),f(e)}return d=a.extend({},a.fn.jScrollPane.defaults,d),a.each(["mouseWheelSpeed","arrowButtonSpeed","trackClickSpeed","keyboardSpeed"],function(){d[this]=d[this]||d.speed}),this.each(function(){var b=a(this),c=b.data("jsp");c?c.reinitialise(d):(c=new e(b,d),b.data("jsp",c))})},a.fn.jScrollPane.defaults={showArrows:!1,maintainPosition:!0,stickToBottom:!1,stickToRight:!1,clickOnTrack:!0,autoReinitialise:!1,autoReinitialiseDelay:500,verticalDragMinHeight:0,verticalDragMaxHeight:99999,horizontalDragMinWidth:0,horizontalDragMaxWidth:99999,contentWidth:c,animateScroll:!1,animateDuration:300,animateEase:"linear",hijackInternalLinks:!1,verticalGutter:4,horizontalGutter:4,mouseWheelSpeed:0,arrowButtonSpeed:0,arrowRepeatFreq:50,arrowScrollOnHover:!1,trackClickSpeed:0,trackClickRepeatFreq:70,verticalArrowPositions:"split",horizontalArrowPositions:"split",enableKeyboardNavigation:!0,hideFocus:!1,keyboardSpeed:0,initialDelay:300,speed:30,scrollPagePercent:.8}}(jQuery,this),null==String.prototype.indexOfRegExp&&(String.prototype.indexOfRegExp=function(a,b){var c=new RegExp(a,b),d=c.exec(this.valueOf());return null==d?-1:d.index}),function(a){a.fn.column=function(b){function c(a){var b=jQuery('<div style="display:none;height:10em;margin:0;padding:0;border:0;"></div>').appendTo(a),c=b.height()/10;return b.remove(),c}function d(a){var b=jQuery('<div style="border:'+a+' solid transparent;height:0px;"></div>').appendTo("body"),c=b.outerHeight()/2;return b.remove(),c}function e(b){var c=new Array;return a(b).contents().each(function(a,b){3==b.nodeType?c=c.concat(h[f.split](b)):c.push(b)}),c}var f={width:"auto",count:"auto",gap:"normal",rule_color:"",rule_style:"none",rule_width:"medium",split:"word",before:null,after:null},g={thin:d("thin"),medium:d("medium"),thick:d("thick")},h={word:function(a){var b=new Array;do b.push(a),(split=a.nodeValue.indexOfRegExp("\\s+")+1)&&(split<a.length?a=a.splitText(split):split=0);while(split);return b},sentence:function(a){var b=new Array;do b.push(a),(split=a.nodeValue.indexOfRegExp("[.:!?]+")+1)&&(split<a.length?a=a.splitText(split):split=0);while(split);return b}};"function"==typeof f.before&&f.before.call();var i=this.each(function(){function d(){a(h).empty();var b=f.gap==parseFloat(f.gap)?f.gap:k;if("none"!=f.rule_style){var c=f.rule_color?f.rule_color:a(h).css("color"),d=f.rule_width==parseFloat(f.rule_width)?f.rule_width:g[f.rule_width];b-=d}if("auto"!=f.width)var e=Math.floor((a(h).width()+d)/(f.width+b));else{if("auto"==f.count)return;var e=f.count}for(var l=a(h).width()-(e-1)*b,m=Math.floor(l/e),n=0,o=0;e>o;++o){var p="position:absolute;"+(o>0?"left:"+(n-Math.floor(b/2))+"px;":"")+"width:"+m+"px;"+(o>0?"padding-left:"+Math.ceil(b/2)+"px;":"")+(e-1>o?"padding-right:"+Math.floor(b/2)+"px;":"")+"overflow:hidden;";n+=m,n+=b,o>0&&"none"!=f.rule_style&&(p+="border-left:"+d+"px "+f.rule_style+" "+c+";",n+=d),a(h).append('<div style="'+p+'"></div>')}var q=a("div",h).first(),r=q.html(i).height();q.empty();for(var s=Math.ceil(r/e),t=j.length,u=0,v=0,o=0;e>o;++o){var w=a("div",h).eq(o);if(e-1>o){for(;t>v&&w.height()<=s;)w.append(j[v++]);for(var x=w.height();t>v&&w.height()==x;)w.append(j[v++]);w.contents().last().remove(),--v}else for(;t>v;)w.append(j[v++]);u=Math.max(u,w.height())}a("div",h).css("height",u),a(h).css("height",u)}b&&a.extend(f,b);var h=this,i=a(this).html(),j=e(this),k=c(this);d(),a(window).resize(d).load(d)});return"function"==typeof f.after&&f.after.call(),i}}(jQuery);