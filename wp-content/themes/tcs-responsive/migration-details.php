<?php
/**
 * Template Name: Angular Challenge Details Migration
 */
...
<div id="main">
  <div ng-include src="'ng-content-basic-challenge-details.html'"></div>
    ...
    <div class="container">
      <div class="rightSplit  grid-3-3">
            ...
            <table class="registrantsTable">
              ...
              <tbody>
                <tr ng-repeat="registrant in CD.challenge.registrants | orderBy:'registrationDate'">
                  ...
                  <td ng-show="CD.isLC">
                    <a ng-href="{{tcLCApiURL}}/challenges/{{challengeId}}/scorecards/">View</a>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div id="winner" class="tableWrap {{CD.activeTab != 'results' ? 'hide' : ''}} tab">
          <div ng-include src="'ng-page-challenge-result.html'"></div>
        </div>
        <div id="checkpoints" class="tableWrap {{CD.activeTab == 'checkpoints' ? '' : 'hide'}} tab">


          <article>
            <div ng-include src="'ng-content-checkpoint.html'"></div>
          </article>
        ...
        <div id="submissions" class="tableWrap {{activeTab != 'submissions' ? 'hide' : ''}} tab">
          ...
          <article>
            <div ng-include src="'ng-content-submission.html'"></div>
          </article>
        ...
        <div class="slider">
          <ul>
            <div ng-hide="CD.isDesign" class="slideBox">
              <div ng-include src="'ng-content-challenge-downloads.html'"></div>
            </div>
...
<script type="text/ng-template" id="ng-content-basic-challenge-details.html">
  <div class="container">
...
<script type="text/ng-template" id="ng-content-challenge-downloads.html">
  <h3>Downloads:</h3>
  <div class="inner">
...
<script type="text/ng-template" id="ng-page-challenge-result.html">
  <div ng-controller="SubmissionCtrl as subCtrl">
    <article ng-if="CD.isDesign && CD.submissions.length > 0" ng-hide="subCtrl.singleViewMode">
      <div ng-if="CD.firstPlaceSubmission" ng-repeat="submission in CD.winningSubmissions" class="winnerRow {{$index > 1 ? 'hideOnMobi' : ''}}">
        ...
        <!-- #/end image-->
        <div class="details">
          <a href="/member-profile/{{submission.handle}}" class="coderTextOrange">{{submission.handle}}</a>
          <div class="">
    ...
    <article ng-if="!CD.isDesign && CD.submissions.length > 0">
      <div ng-if="CD.challenge.challengeType != 'Code' && CD.firstPlaceSubmission" class="winnerRow">
        ...
        <!-- #/end place-->
        <div class="details">
            <a href="/member-profile/{{CD.firstPlaceSubmission.handle}}" class="coderTextYellow">{{CD.firstPlaceSubmission.handle}}</a>
        </div>
        <!-- #/end details-->
        <div class="price">
      ...
      <div ng-if="CD.challenge.challengeType != 'Code' && CD.secondPlaceSubmission && CD.challenge.prize[1]" class="winnerRow">
        ...
        <!-- #/end place-->
        <div class="details">
          <a href="/member-profile/{{CD.secondPlaceSubmission.handle}}" class="coderTextGray">{{CD.secondPlaceSubmission.handle}}</a>
        </div>
        <!-- #/end details-->
        <div class="price">
      ...
      <div ng-if="CD.challenge.challengeType == 'Code' && CD.firstPlaceSubmission" ng-repeat="submission in CD.winningSubmissions" class="winnerRow">
        ...
        <!-- #/end place-->
        <div class="details">
          <a href="/member-profile/{{submission.handle}}" class="coderTextYellow">{{submission.handle}}</a>
        </div>
        <!-- #/end details-->
        <div class="price">
      ...
      <table class="registrantsTable hideOnMobi">
        ...
        <tbody>
          <tr ng-repeat="submission in CD.submissions" class="{{$index % 2 == 1 ? 'alt' : ''}}">
            <td class="leftAlign"><a href="/member-profile/{{submission.handle}}" class="coderTextGray">{{submission.handle}}</a></td>
      ...
      <div class="registrantsTable onMobi">
        ...
        <div ng-repeat="submission in CD.submissions" class="registrantSection">
          <div class="registrantSectionRow registrantHandle"><a href="/member-profile/{{submission.handle}}" class=" coder coderTextYellow">{{submission.handle}}</a></div>
    ...
    <div ng-include src="'ng-content-submission-single-view.html'"></div>

  </div>
</script>
<script type="text/ng-template" id="ng-content-submission.html">
  <div ng-controller="SubmissionCtrl as subCtrl">
...
<script type="text/ng-template" id="ng-content-submission-single-view.html">
    ...
    <div class="informationView">
      ...
      <div class="furtherInfo">
        ...
        <div class="stockArtInfo">
          ...
          <!-- remove the jsSeeMore class so we wont use old jquery code. -->
...
<script type="text/ng-template" id="ng-content-checkpoint.html">
